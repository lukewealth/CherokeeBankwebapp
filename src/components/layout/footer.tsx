        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-[11px] text-white/25 leading-relaxed max-w-50 mb-4">
              CHEROKEE BANK — Redefining Global Banking
            </p>
            ...
            <div className="flex items-center gap-2">
              {/* X / Twitter */}
              <a href="https://x.com/Cherokeedigital" className="group p-1.5 rounded-md bg-white/3 border border-white/5 hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/10 transition-all duration-300">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/groups/16181066" className="group p-1.5 rounded-md bg-white/3 border border-white/5 hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/10 transition-all duration-300">
                <svg viewBox="0 0 24 24" className="w-3 h-3 text-white/25 group-hover:text-[#D4AF37] transition-colors" fill="currentColor">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
              </a>
              {/* Instagram */}
              <a href="https://www.instagram.com/cherokeedigital" className="group p-1.5 rounded-md bg-white/3 border border-white/5 hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/10 transition-all duration-300">
                <svg viewBox="0 0 24 24" className="w-3 h-3 text-white/25 group-hover:text-[#D4AF37] transition-colors" fill="currentColor">
              ...
              {/* TikTok */}
              <a href="https://www.tiktok.com/@cherokeedigital" className="group p-1.5 rounded-md bg-white/3 border border-white/5 hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/10 transition-all duration-300">
                <svg viewBox="0 0 24 24" className="w-3 h-3 text-white/25 group-hover:text-[#D4AF37] transition-colors" fill="currentColor">
                  <path d="M12.5 2v7.5a3.5 3.5 0 01-3.5-3.5C9 5.119 10.119 4 11.5 4H12V2h.5zM17 8.5v3a5.5 5.5 0 01-5.5 5.5A5.5 5.5 0 016 11.0H8a3.5 3.5 0 003.5 3.5A3.5 3.5 0 0015 11V8.5h2z"/>
                </svg>
              </a>
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61584556345351" className="group p-1.5 rounded-md bg-white/3 border border-white/5 hover:border-[#D4AF37]/40 hover:bg-[#D4AF37]/10 transition-all duration-300">
                <svg viewBox="0 0 24 24" className="w-3 h-3 text-white/25 group-hover:text-[#D4AF37] transition-colors" fill="currentColor">
