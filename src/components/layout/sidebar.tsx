...
import { Home, Wallet, TrendingUp, Send, BarChart, Settings, Bot, Building, CreditCard, PiggyBank, ChevronLeft, ChevronRight } from "lucide-react"
...
const navLinks = [
  ...
  { href: "/dashboard/savings", icon: PiggyBank, label: "Savings", badge: "New" },
